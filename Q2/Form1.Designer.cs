namespace Q2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "請輸入日期 (例如2022/10/26)";
			// 
			// dateTextBox
			// 
			this.dateTextBox.Location = new System.Drawing.Point(71, 58);
